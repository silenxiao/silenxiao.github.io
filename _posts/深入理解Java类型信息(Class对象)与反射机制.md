...
![20170430093618437.png](resources/62C5C70F0321822B337331CE18E43D33.png =597x313)
...
* lass类的对象作用是运行时提供或获得某个对象的类型信息，这点对于反射技术很重要(关于反射稍后分析)。
